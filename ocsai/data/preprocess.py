...
question_inference_mapping = {'ara': {'uses': {'TIN CANS': 'ما هو الاستخدام المفاجئ لـ TIN CANS؟'}},
 ...
 'eng': {'completion': {'GAMES': 'Complete this sentence in a surprising way: "At a sleepover, we..."',
  ...
  'consequences': {'KID PRESIDENT': 'What would be a surprising consequence if A KID WERE PRESIDENT?',
   'RAIN SODA': 'What would be a surprising consequence if RAIN WERE MADE OF SODA?'},
  'metaphors': {'BORING CLASS': 'Think of the most boring high school or college class you’ve ever taken. What was it like to sit through it?',
  ...
  'uses': {'BOOK': 'What is a surprising use for a BOOK?',
 ...
 'ita': {'uses': {'BOTTIGLIA DI PLASTICA': 'Qual è un uso sorprendente per una BOTTIGLIA DI PLASTICA?',
